 ...
 */
final class Version20260321155051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rental (id INT AUTO_INCREMENT NOT NULL, purchase_date DATE NOT NULL, company_id INT DEFAULT NULL, offer_id INT NOT NULL, INDEX IDX_1619C27D979B1AD6 (company_id), INDEX IDX_1619C27D53C674EE (offer_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
