 ...
 */
final class Version20260328154654 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE intervention (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) DEFAULT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, technician_id INT NOT NULL, unit_id INT DEFAULT NULL, INDEX IDX_D11814ABE6C5D496 (technician_id), INDEX IDX_D11814ABF8BD700D (unit_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE rental (id INT AUTO_INCREMENT NOT NULL, purchase_date DATE NOT NULL, is_auto_renew TINYINT(1) NOT NULL, end_date DATETIME NOT NULL, company_id INT DEFAULT NULL, offer_id INT NOT NULL, INDEX IDX_1619C27D979B1AD6 (company_id), INDEX IDX_1619C27D53C674EE (offer_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE unit_rental_histo (id INT AUTO_INCREMENT NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, unit_id INT NOT NULL, rental_id INT NOT NULL, INDEX IDX_A0DA0952F8BD700D (unit_id), INDEX IDX_A0DA0952A7CF2329 (rental_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, is_verified TINYINT(1) NOT NULL, company_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649979B1AD6 (company_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
