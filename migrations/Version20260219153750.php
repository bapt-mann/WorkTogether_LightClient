 ...
 */
final class Version20260219153750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD customer_id INT DEFAULT NULL, ADD company_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP customer_id, DROP company_id');
    }
}
